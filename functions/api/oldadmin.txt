 ...
 * FINAL CLEANED VERSION: This file handles ONLY admin-related actions.
 */
...
export async function onRequest(context) {
    // This function now ONLY handles routes under /api/admin/
    // Login is handled by a separate file. All other actions require auth.
    ...
    try {
        ...
        return new Response(JSON.stringify({ error: 'Admin route not found' }), { status: 404 });
    } catch (err) {
...
// --- SERMON GENERATION LOGIC (Needed for force-generate) ---
// ... (The full, working sermon generation logic is included here)
